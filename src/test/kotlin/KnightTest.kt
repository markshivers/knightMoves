...
class KnightTest {
    ...
    fun `Test multiple paths`(startingSpace: Point, destination: Point, chessBoard: ChessBoard) {
        ...
        println("Arrived at destination in ${path.toList().size} moves, $path")
...
//            Arguments.of(Point(24, 31), Point(0, 99), ChessBoard(100, 100)),
            Arguments.of(Point(24, 31), Point(0, 99), ChessBoard(-1, -1)),
            Arguments.of(Point(24, 31), Point(234, 321), ChessBoard(-1, -1)),
        )
